...
[`@aws-sdk/client-resource-explorer-2`](https://www.npmjs.com/package/@aws-sdk/client-resource-explorer-2/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-explorer-2@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dvN/CLUphDtKi0UTuOclMY2b4xy4pKVx+vtCSAGbCI/KVfaT+e3Ym2kT+ETt53AT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-resource-explorer-2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-explorer-2@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-explorer-2@3.310.0/index.min.mjs": "sha384-dvN/CLUphDtKi0UTuOclMY2b4xy4pKVx+vtCSAGbCI/KVfaT+e3Ym2kT+ETt53AT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-resource-explorer-2/blob/refs/tags/3.310.0/LICENSE
```
